...
#            writer.writerows(agent)
    def plot_summary(self,agent):
        ...
        self.predict_angle_ploter.ax[0].plot(agent.actor.set_point_predict_angle_diffrence,'g',linewidth=0.5)
        self.predict_angle_ploter.ax[0].set_xlabel('steps')
        self.predict_angle_ploter.ax[0].set_ylabel('predict_angle_diffrence-red/set_point_predict_angle_diffrence-green')
